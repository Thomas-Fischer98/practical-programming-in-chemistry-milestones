...
| 1    | Create a conda environment                  | I had Anaconda already installed and so I used Anaconda prompt |
| 1    | Fork a Repo                                 | https://github.com/Thomas-Fischer98/practical-programming-in-chemistry-milestones |
| 1    | (Optional) Make a Pull Request              | |
| 2    | (Optional) Review a Pull Request            | |
| 4    | Update `env.yml` via a Pull Request         | https://github.com/Thomas-Fischer98/ppchem/blob/main/env.yml |
